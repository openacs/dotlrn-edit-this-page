...
ad_library {
    ...
    Procs to set up the dotLRN Edit-this-page applet
...
namespace eval dotlrn_edit-this-page {
    ...
    ad_proc -public add_applet {
        ...
        Add the edit-this-page applet to dotlrn - one time init - must be repeatable!
    } {
    ...
    ad_proc -public add_applet_to_community {
        ...
        Add the edit-this-page applet to a specific community
    } {
        set portal_id [dotlrn_community::get_portal_id \
                           -community_id $community_id
        ]

        # create the edit-this-page package instance (all in one, I've mounted it)
        ...
        # set up the edit-this-page portlet for this community
        ...
        dotlrn_edit-this-page::add_portlet_helper $portal_id $args
    ...
    ad_proc -public remove_applet_from_community {
        ...
        Drops the edit-this-page applet from the given community
    } {
    ...
    ad_proc -public clone {
        ...
        db_exec_plsql call_edit-this-page_clone {}
